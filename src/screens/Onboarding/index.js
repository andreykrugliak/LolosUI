                        ...
                        <View style={{flex:1,backgroundColor:'white'}}>
                            ...
                            <ScrollView showsVerticalScrollIndicator={false} >
                                ...
                                <Text style={styles.privacyText}>
                                    ...
                                    “Lolos ” means <Text style={{color:'#ff009d',fontStyle:'italic'}} >Lolos</Text> ;
                                    ...
                                    “Personal Data” means any personal information provided by you via the Services including (without limitation) the personal information described in Lolos ’s Privacy Policy;
                                    ...
                                    GetyourLolos @gmail.com or write to Lolos office address:
                                    Lolos
                                    Halamish 14, Caesarea
                                    Israel {'\n'}{'\n'}
                                    ...
                                    4.1 Lolos reserve the right at any time to: (i) modify or withdraw the Services (or any part of them) without notice to you and will not be liable to you for any such modification or withdrawal; and/or (ii) change these Conditions from time to time and your continued use of the Services (or any part of them) following such change will be deemed to be your acceptance of such change.
                                    ...
                                    5.1.1 Lolos provide a pocket money earning & management facility in the Services, which helps teenagers earn manage spend pocket money in a safe environment. 


                                    5.1.2 The Lolos Services are only intended for use by people resident in the United State of America. You must comply with all applicable laws and regulations in the country which you are resident. Lolos will not be liable for any breach by you of any such laws.
                                    ...
                                    5.2.2 You must restrict access to your phone to prevent unauthorized access to your account. Lolos may rely on any use of the Services from your phone as being authorized by you.


                                    5.2.3 Please inform Lolos immediately if you have any reason to believe that your account details have become known to anyone else or if they are being, or are likely to be, used in an unauthorized manner.


                                    5.3 Using your basic Membership Account


                                    5.3.1 If your membership registration has been accepted, Lolos will confirm this to you on-screen, at which point your Membership Account will be activated. From this time, and unless and until your Membership Account is terminated, you will be entitled, subject to any restrictions contained in these Conditions (including without limitation the Members Conduct Rules) (see Condition 5.4) to upload and/or post any Submission to or on the Services.
                                    ...
                                    5.4.1 Lolos are committed to ensuring that the Services remains fun and safe for Users. The Services rely on members making or uploading Submissions. By accessing and using the Services, you warrant that you will only use the Services for lawful purposes, and will not upload or submit to or on the Services any Submission which is a Prohibited Submission.


                                    5.4.2 You acknowledge and agree that notwithstanding that Lolos have the right (but not the obligation) to examine any Submission which you submit or upload to or on the Services, each such Submission is your sole responsibility and that by using the Services you may be exposed to content which you consider to be offensive or harmful.


                                    5.4.3 Subject to the Condition 9, Lolos will not be liable to you for any loss or damage which you may suffer or incur as a direct or indirect result of any such exposure. You also acknowledge and agree that this means that you are responsible for the Submissions which you submit or upload to or on the Services.
                                    ...
                                    (iiii) You engage in any conduct which Lolos believe, in its sole discretion, to be harmful to its business or to other Users; or
                                    ...
                                    (vi) If Lolos decide to sell its business or assets to a third party.


                                    5.5.2 Lolos take your privacy extremely seriously. If you wish your data to be deleted when your account is closed please notify customer services.


                                    5.5.3 If your Membership Account is terminated for any reason, Lolos reserve the right without notice to you to de-activate any hyperlink through which it may from time to time have given you access to your Membership Account and to permanently remove and discard any Submission you have made.

                                        {'\n'}{'\n'}
                                    6.	Your Personal Information{'\n'}{'\n'}


                                    6.1 Lolos are committed to protecting your privacy. Our privacy policy sets out how Lolos   will use your Personal Data. When you submit your Personal Data, you are giving your consent to the collection, use and disclosure of your Personal Data as set forth in Lolos ’s Privacy Policy.
                                    ...
                                    10.1 The contract between you and Lolos is binding on both parties’ respective successors and assigns. You may not transfer, assign, charge or otherwise dispose of a contract, or any of your rights or obligations arising under it, without our prior written consent. Lolos may transfer, assign, charge, sub-contract or otherwise dispose of a contract, or any of our rights or obligations arising under it, at any time during the term of the contract.

                                    {'\n'}{'\n'}
                                    11.	Events Outside Our Control{'\n'}{'\n'}


                                    11.1 Lolos not be liable or responsible for any failure to perform, or delay in performance of, any of their obligations under a contract that is caused by a Force Majeure Event (events outside our reasonable control).


                                    11. 2 A Force Majeure Event includes any act, event, non-happening, omission or accident beyond Lolos ’s reasonable control and includes in particular (without limitation) the following:
                                    ...
                                    11.3 Lolos performance under any contract is deemed to be suspended for the period that the Force Majeure Event continues, and it will have an extension of time for performance for the duration of that period. Lolos  will use reasonable endeavors to bring the Force Majeure Event to a close or to find a solution by which our obligations under the contract may be performed despite the Force Majeure Event.

                                        {'\n'}{'\n'}
                                    12.	Waiver{'\n'}{'\n'}


                                    12.1 If Lolos fail, at any time during the term of a contract, to insist upon strict performance of any of your obligations under the contract or any of these Conditions, or if Lolos fail to exercise any of the rights or remedies to which it is entitled under these Conditions, this shall not constitute a waiver of such rights or remedies and shall not relieve you from compliance with such obligations.


                                    12.2 A waiver by Lolos of any default shall not constitute a waiver of any subsequent default.


                                    12.3 No waiver by Lolos of any of these Conditions shall be effective unless it is expressly stated to be a waiver and is communicated to you in writing.
    ...
    render() {
        ...
        return (
            ...
            <View style={styles.container}>
                ...
                <Text style={styles.shoppingText}>Get them, Use them</Text>
